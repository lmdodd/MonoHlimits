...
int main() {
  ...
  bkg_procs["mt"] = {"ZTT", "W", "QCD", "TT", "VV","ZVV"};
  ...
  vector<string> sig_procs = {"ZprimeA300Z"};
 ...
 //             ({"13TeV"}, 1.062));
  ...
  cb.cp().process(ch::JoinStr({sig_procs,{"ZTT", "W", "TT", "VV","ZVV"} }))
  ...
  cb.cp().process({"ZTT","ZVV"}).AddSyst(cb,
    "CMS_xtt_zjXsec_13TeV", "lnN", SystMap<>::init(1.04));
  ...
  cb.cp().AddSyst(cb, "CMS_eff_m", "lnN", SystMap<channel, process>::init
    ({"3t"}, ch::JoinStr({sig_procs, {"ZTT", "TT", "VV", "W"}}),  1.02));
  
  //cb.cp().AddSyst(cb, "CMS_eff_e", "lnN", SystMap<channel, process>::init
  //  ({"et"}, ch::JoinStr({sig_procs, {"ZTT", "TT", "VV", "W"}}),  1.02));
  ...
  cb.cp().process({"W"}).channel({"mt"}).AddSyst(cb,
    "CMS_xtt_wjXsec_13TeV", "lnN", SystMap<>::init(1.04));
  ...
  TFile output("output/xtt_cards/xtt_Boost.input.root", "RECREATE");
